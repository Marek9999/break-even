...
import { Wallet, CreditCard, History, Link2 } from "lucide-react";
          ...
          {bankAccounts.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-4 text-center">
              <div className="p-4 rounded-full bg-white/10 mb-4">
                <Link2 className="h-8 w-8 text-stone-300" />
              </div>
              ...
              <PlaidLink 
                variant="outline" 
                className="bg-white text-stone-900 hover:bg-stone-100 border-0"
              />
            </div>
          ) : (
